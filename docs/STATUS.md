...
| 프로덕션 CORS 제한은 아직 코드에서 환경별 설정을 받지 않아 운영 하드닝이 남아 있음 | 중간 | 진행 예정 |
...
| 프로덕션 CORS, 보안 헤더, rate limiting을 환경별로 제어할 수 있도록 서버 설정 하드닝 | 2026-03-27 | 반나절~1일 |
